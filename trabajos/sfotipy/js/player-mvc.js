...
View.prototype.updateActive = function( song ){
	this.elems.front.attr('src', song.img)
...
var controller = {
	init: function(){
		...
		this.model.setSongs([
			{
				name: 'Entre pairos y derivas',
				artist: 'Fernando Delgadillo',
				src: 'media/Fernando_Delgadillo_-_Entre_pairos_y_derivas.mp3',
				img: 'img/songs/Fernando_Delgadillo_-_Entre_pairos_y_derivas.jpg'
			},
			{
				name: 'Hoy ten miedo de mi',
				artist: 'Fernando Delgadillo',
				src: 'media/Fernando_Delgadillo_-_Hoy_ten_miedo_de_mi.mp3',
				img: 'img/songs/Fernando_Delgadillo_-_Hoy_ten_miedo_de_mi.jpg'
			},
			{
				name: 'Entre pairos y derivas',
				artist: 'Fernando Delgadillo',
				src: 'media/Fernando_Delgadillo_-_No_me_pidas_ser_tu_amigo.mp3',
				img: 'img/songs/Fernando_Delgadillo_-_No_me_pidas_ser_tu_amigo.jpg'
			}
		])
